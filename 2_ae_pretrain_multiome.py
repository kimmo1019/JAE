...
par = {
    'input_mod1': 'public_data/explore/multiome/multiome_gex_processed_training.h5ad',
    'input_mod2': 'public_data/explore/multiome/multiome_atac_processed_training.h5ad',
    'output': 'logs/output_multiome.h5ad',
    'n_dim': 200,
}
